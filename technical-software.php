...
<div class="content_wrapper">
    <div class="breadcrumb_wrap" data-stellar-background-ratio="0.3" style="background: url(images/slider_group_in_campus.jpg); background-attachment: fixed; background-position: 50% 50%;">
        <div class="breadcrumb_wrap_inner">
            <div class="container">
                <h1>Technical Software</h1>
                <ul class="breadcrumbs">
                    <li><a href="/">Home</a> /</li>
                    <li><a href="technical-software.php">Technical Software</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="dtl_block">
                        <div class="detail_text_wrap">
                            <div class="info_wrapper">
                                <h5>Category Technical Software</h5>
                                <div class="panel-group" id="accordion">
                                    <?php 
                                        ...
                                        if($Category_id=='Technical Software' && $total_fee && $eligibility){
                                    ?>
                                    <div class="panel panel-default">
                                        <div class="panel-heading" id="head_One">
                                            <h4 class="panel-title">
                                                <a href="course-info.php?submenu=<?php echo $submenu; ?>">
                ...
                <div class="course_tags">
                    ...
                    <ul>
                        <li><?php 
                            ...
                            ?>
                            <a href="<?php echo $row['CourseLink']; ?>"><?php echo $CourseCategory; ?></a>
                            <?php } ?>
                        </li>
                    </ul>
                </div>
