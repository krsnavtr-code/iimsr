...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>View Send Sample Users <small></small></h1>

        <ol class="breadcrumb">

            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>

            <li class="active">View Send Sample Users </li>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="overflow-x:auto; margin-bottom: 20px; height:440px;">
                ...
                <table class="table table-hover no-more-tables" id="tbllData" style="background-color: #fff;">
                    ...
                    <?php
                        ...
                        $query = mysqli_query($con, "SELECT * FROM `sample_send` ORDER BY `id` DESC");
                        ...
                        if($num>0){
                            ...
                            if(isset($_POST['search'])){
                                ...
                                $query = mysqli_query($con,"SELECT * FROM `sample_send` WHERE CONCAT(`name`, `email`, `phone_no`) LIKE '%".$serach."%'");
