...
if(isset($_POST['sendmail'])){
    ...
    if($sqlfff){
	    ...
	    $success1 = "<p class='OperationHas'>Thank You...! Login Password send successfully</p>";

	}else{

		$success1 = "<p class='AlreadyRegistered'>Ooops...! Login Password sending failed</p>";
...
if(isset($_POST['resultpass'])){
    ...
    <span style='color:#500050'>Website : </span><a href='https://www.iimsr.net.in' style='text-decoration:none' rel='noreferrer' target='_blank' data-saferedirecturl='https://www.google.com/url?q=https://iimsr.net.in&amp;source=gmail&amp;ust=1591852093685000&amp;usg=AFQjCNHDR5wbJRaaq0RfkyBNWK71E_kyOA'><strong>www.iimsr.net.in</strong></a> .
...
if(isset($_POST['alertmessage'])){
    ...
    <span style='color:#500050'>Website : </span><a href='https://www.iimsr.net.in' style='text-decoration:none' rel='noreferrer' target='_blank' data-saferedirecturl='https://www.google.com/url?q=https://www.iimsr.net.in&amp;source=gmail&amp;ust=1591852093685000&amp;usg=AFQjCNHDR5wbJRaaq0RfkyBNWK71E_kyOA'><strong>www.iimsr.net.in</strong></a> .
        ...
        $subject = "Alert!.. Message from Imperial Institute of Management Science & Research";
    ...
    if($sqlfff){
		...
		$success3 = "<p class='AlreadyRegistered'>Ooops...! alert message sending failed</p>";
    ...
    <section class="content-header">
        ...
        <h1>
            ...
            <?php  if($_SESSION['role']=="super-admin"){ ?>
                ...
                <i class="fa fa-arrow-circle-right" aria-hidden="true"></i> <a href="view-new-registration.php">View All Student</a> 
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">View New Registration</li>
