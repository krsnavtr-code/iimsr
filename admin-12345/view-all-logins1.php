            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="overflow-x:auto; margin-bottom: 20px; height:530px;">
                <table class="table table-hover no-more-tables" style="background-color: #fff;">
                    ...
                    <tr>
                        ...
                        <td>
                            <form class="floatData" name="useredata" method="post" action="ChangePassword.php">
							    ...
							    <input type="submit" name="UpdatePassword" value="Update Password" class="btn btn-warning btn-xs btn-flat btn-block ActionButtonRa">
						    </form>
                        </td>			 	  
                    </tr>
                    <?php } } ?>
