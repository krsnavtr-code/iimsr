...
.cmm-image {
    background-image: url('pdf-folder/iimsr-markscard-lowres.jpeg'); /* Placeholder image */
    background-size: cover;
}
.cmm-image.loaded {
    background-image: url('pdf-folder/Marks-Card.jpeg'); /* High-resolution image */
}

</style>

<img class="cmm-image" id="cmmImage" style="width:100%; height:782px; opacity: 0.9;" src="pdf-folder/iimsr-markscard-lowres.jpeg" alt="DZone"/>

<!-- <img style="width:100%; height:782px; opacity: 0.9;" src="pdf-folder/Marks-Card.jpeg" alt="DZone"/> -->

<table style="width:90%;margin-top:-724px;margin-left:17px;opacity: 0.9;padding-left:10px;padding-right:10px;z-index:9999999;line-height:20px">

    <tr>

        <td>

            <table style="width: 100%; margin-top: 6px; margin-left: 0px;">

                <tr>

                    <td style="width: 65px; height: 65px;opacity: 0.9;z-index: 99999999;float:right;margin-left:997px;margin-right: 46px;">

                        <img src="data:image/gif;base64,<?php echo base64_encode($img);?>" style="opacity: 0.9;margin-top: -20px;" alt="DZone"/>
            ...
            <table style="width:97%;margin-top:3px;margin-right:0px;margin-left: -3px;" align="right">

                <tr>

                    <td style="padding-left: 716px;line-height: 28px;"><span style="font-size:24px;font-weight:bold">20<?php echo $yearhsag; ?></span></td>
            ...
            <table style="width:97%;margin-top:56px;margin-left: 0px;">
            ...
            <table style="width:97%;padding-right:50px;margin-left: 0px;line-height:25px;margin-top:-1px">	
            ...
            <table bordercolor="black"style="width:97%;margin-top:-1px;height:192px;border:1px solid #000;text-align:center;margin-left: 3px;">
            ...
            <table style="width:97%;margin-top:17px;margin-bottom: 0px;height:60px;border:1px solid #000;text-align:center;margin-left: 3px;">
...
<img style="margin-top:10px;width:100%;height:782px;opacity: 0.6;" src="pdf-folder/iimsr-marks-back.jpeg" alt="DZone"/>

<script> 

const highResImage = new Image();
highResImage.src = 'pdf-folder/Marks-Card.jpeg';
highResImage.onload = () => {
