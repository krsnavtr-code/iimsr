...
<title>Imperial Institute of Management Science & Research | Online Examination</title>
...
<body>
            ...
            <div class="col-md-5 col-sm-5 col-xs-5">
                <?php
                    ...
                    if (!(isset($_SESSION['exami_unique_code']))) {
                        ...
                        include("dbconnection.php");
                        echo '<span class="pull-right top title1" ><span style="color:white"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <span class="log log1" style="color:lightyellow"><span class="SessionNameShow">'.$name.'&nbsp;&nbsp;</span>|&nbsp;&nbsp;<a href="logout.php?q=account.php" style="color:lightyellow"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Logout</button></a></span>';
                    }
                ?>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <?php
                        if (@$_GET['q'] == 1) {
                            ...
                            $c = 0;
                            echo '</table></div><div class="panel ImportantNoticee" style="padding-top:1px;padding-left:10%;padding-right:10%;word-wrap:break-word"><h3 align="center" style="font-family:calibri" class="NotesImportant">:: Important Note! ::</h3><br /><ul type="circle" class="NoticeImpo"><font style="font-size:14px;font-family:calibri">';
                            echo'<ul>
                                ...
                                <li>You can see the history of test taken and scores in the <b>"History"</b> section.</li>
                                <li>To start the test, click on <b>"Start"</b>.</li>
                                ...
                                <li>To mark an answer you need to select it and press the <b>"Lock"</b> button. Upon locking, the selected answer would be displayed and the question will be marked "green"
                                To delete an answer press <span style="color:darkred:font-size:12px" class="glyphicon glyphicon-remove"></span>.</li>
                                ...
                                <li>0 marks would be awarded for the questions that are <b>"not marked"</b> (having <b>  "red" </b>status).
                                If you get some error, you can contact us via <a href=feedback.php>this form</a></li>
                                </ul>';
                            echo '</font></ul></div>';
                        }
                    ?>
                    <?php
                        ...
                        if (@$_GET['q'] == 'result' && @$_GET['eid']){
                            ...
                            if ($status == "finished"){
                                ...
                                echo '<tr style="color:darkblue;font-size: 16px;"><td style="vertical-align:middle;">Total Questions</td><td style="vertical-align:middle">'.$total.'</td></tr>
                                <tr style="color:darkgreen;font-size: 16px;"><td style="vertical-align:middle">Correct Answer&nbsp;<span class="glyphicon glyphicon-ok-arrow" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $r . '</td></tr> 
                                <tr style="color:red;font-size: 16px;"><td style="vertical-align:middle">Wrong Answer&nbsp;<span class="glyphicon glyphicon-remove-arrow" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $w . '</td></tr>
                                <tr style="color:orange;font-size: 16px;"><td style="vertical-align:middle">Unattempted&nbsp;<span class="glyphicon glyphicon-ban-arrow" aria-hidden="true"></span></td><td style="vertical-align:middle">' . ($total - $r - $w) . '</td></tr>
                                <tr style="color:darkblue;font-size: 16px;"><td style="vertical-align:middle">Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr>';
                                $q = mysqli_query($con, "SELECT * FROM examvb_rank WHERE  exami_unique_code='$username' ") or die('Error157');
                                while ($row = mysqli_fetch_array($q)) {
                                    $s = $row['score'];
                                    echo '<tr style="color:#990000;font-size: 16px;"><td style="vertical-align:middle">Overall Score&nbsp;<span class="glyphicon glyphicon-stats" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr>';
                                }
                                    echo '<tr></tr></table></div><div class="panel"><br /><h3 align="center" style="font-family:calibri">:: Examination Analysis ::</h3><br /><ol style="font-size:20px;font-weight:bold;font-family:calibri;margin-top:20px">';
                        ...
                        if (@$_GET['q'] == 2){
                            $q = mysqli_query($con, "SELECT * FROM `examvb_history` WHERE `exami_unique_code`='$username' AND `status`='finished' ORDER BY `date` DESC ") or die('Error197');
                                ...
                                <tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Subject</b></td><td style="vertical-align:middle"><b>Total Questions</b></td><td style="vertical-align:middle"><b>Right</b></td><td style="vertical-align:middle"><b>Wrong<b></td><td style="vertical-align:middle"><b>Unattempted<b></td><td style="vertical-align:middle"><b>Score</b></td><td style="vertical-align:middle"><b>Action<b></td></tr>';
                            $c = 0;
                            while ($row = mysqli_fetch_array($q)) {
                                $eid = $row['eid'];
                                $s   = $row['score'];
                                ...
                                $c++;
                                echo '<tr><td style="vertical-align:middle"><b>'.$c.'</b></td><td style="vertical-align:middle"><b>'.$title.'</b></td><td style="vertical-align:middle"><b>'.$total.'</b></td><td style="vertical-align:middle"><b>'.$r.'</b></td><td style="vertical-align:middle"><b>'.$w.'</b></td><td style="vertical-align:middle"><b>'.($total - $r - $w).'</b></td><td style="vertical-align:middle"><b>'.$s.'</b></td><td style="vertical-align:middle"><b><a href="account.php?q=result&eid='.$eid.'" class="btn ViewwResult" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>View Result</b></td></tr>';
                            }
                                echo '</table></div>';
                        }
                        ...
                        if (@$_GET['q'] == 3) {
                            ...
                            $q = mysqli_query($con, $asdfn);
                                echo '<div class="panel title">
                                <table class="table table-striped title1" >
                                <tr><td style="vertical-align:middle"><b>S.No.</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Course</b></td><td style="vertical-align:middle"><b>Semester</b></td><td style="vertical-align:middle"><b>Enrolment</b></td><td style="vertical-align:middle"><b>Exam Unique Code</b></td><td style="vertical-align:middle"><b>Marks</b></td></tr>';
                            $c = $showfrom-1;
                            ...
                            if($total >= $showfrom){
                                ...
                                while($row = mysqli_fetch_array($q)){
                                    ...
                                    while($row = mysqli_fetch_array($q12)){
                                        ...
                                        echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td style="vertical-align:middle"><b>'.$name.'</b></td><td style="vertical-align:middle"><b>'.$course.'</b></td><td style="vertical-align:middle"><b>'.$semeste.'</b></td><td style="vertical-align:middle"><b>'.$enrolment.'</b></td><td style="vertical-align:middle"><b>'.$unique_code.'</b></td><td style="vertical-align:middle"><b>'.$s.'</b></td><td style="vertical-align:middle">';
                                    }
                                    $c++;
    ...
    <div class="row footer">
        ...
        <div class="col-sm-6 col-md-6 col-xs-12 box DevelopedBy">
            <span href="#" data-target="#login" style="color:lightyellow;font-size:12px;">Developed by : insystadatasoft<br><br></span>
        </div>
    </div>
</body>
</html>
