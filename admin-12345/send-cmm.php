...
if(isset($_POST['emailsend'])){
    ...
    //print_r($file);exit;
    $htmlContent = '<h3>Resend Payment Slip with Attachment by Imperial Institute of Management Science & Research</h3> <p>This email is sent from the Imperial Institute of Management Science & Research </p>';
