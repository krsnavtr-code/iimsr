                        ...
                        <div class="card">
                            <div class="card-body px-0">
                                <?php
                    			    ...
                    			    $CmmLink = $row['CmmLink'];
                    			    $CmmLink = 'https://iimsr.net.in/users/'.$CmmLink;
                    			?>
                                <?php 
                                    echo '<center><a href="'.$CmmLink.'" class="btn btn-primary DownloadResu">Open Degree link</a></center>';
                                ?>
                                <div class="row">
