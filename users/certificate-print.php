...
<?php
    ...
    elseif($course=="Diploma Programme In Textile" && $semester=="semester4"){
    	$certelseificategrad = $qerydata['certificate_grade']/2400*100;
    }
    ...
    $img = ob_get_clean();
?>
<!--<img style="opacity: 0.6;width:100%;height:1035px;" src="images/iimsr-certificate-ok.jpeg" alt="DZone"/>-->
<img style="opacity: 0.6;width:100%;height:1105px;" src="images/iimsr-certificate.jpeg" alt="DZone"/>
<table style="width:97%;margin-top:-688px;opacity: 0.9;z-index:9999999;line-height:20px">
    <tr>
        <td>
            <table style="margin-top:-377px;margin-left: -23px;">
                <tr>
        			<td width="100%" style="font-size:20px;font-weight:bold;color:red;padding-left:637px"><?php echo $enrollement ?></td>
        		</tr>
            </table>
            
            <table style="margin-top:388px;">
                <tr>
        			<td width="100%" style="padding-left: 232px;line-height:50px;font-size:20px"><?php echo $row['name']; ?></td>
        		</tr>
        	</table>
        	<table style="margin-top:-4px;">
                <tr>
        			<td width="100%" style="padding-left: 212px;line-height:50px;font-size:20px"><?php echo $row['fathers_name']; ?></td>
        		</tr>
        	</table>
        	<table height="110px" style="margin-top:-7px">
                <tr>
        			<td width="100%" style="padding-left: 333px;line-height:57px;font-size:20px">
					    <?php 
        		...
        		<tr>
					<td width="50%" style="padding-left:180px;padding-top:11px;line-height:40px;font-size:20px"><?php 
        		...
        		<tr>
        			<td width="100%" style="padding-left: 340px;line-height:50px"></td>
        		</tr>
        		<tr>
        			<td width="100%" style="padding-left: 340px;line-height:50px"></td>
        		</tr>
            ...
            <!--<table style="margin-top: -10px;">-->
                <tr>
        			<td width="50%" style="padding-left: 242px;line-height:48px;font-size:20px"><?php echo $qerydata['certificate_month']; ?></td>
        			<td width="25%" style="padding-left: 98px;line-height:53px;font-size:20px"><?php echo $qerydata['year']; ?></td>
        			<td width="25%" style="padding-left: 100px;line-height:40px;font-size:20px">
    					<?php 
            ...
            <table style="margin-top:35px;">
                <tr>
        			<td style="padding-left: 33px;font-size:20px"><?php echo $qerydata['certificated_deliver_date']; ?></td>
        		</tr>
            </table>
        </td>
    </tr>
</table>
<img style="opacity: 0.6;width:100%;height:1100px;" src="images/certificate-back.jpg" alt="DZone"/>