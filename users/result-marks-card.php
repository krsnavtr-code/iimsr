                        ...
                        <div class="card">
                            <div class="card-body px-0">
                                <?php
                    			    ...
                    			    $ResultPdf = $row['ResultPdf'];
                    			    $ResultPdf = 'https://iimsr.net.in/users/'.$ResultPdf;
                    			?>
                                <?php 
                                    echo '<center><a href="'.$ResultPdf.'" class="btn btn-primary DownloadResu">Open Result link</a></center>';
                                ?>
                                <div class="row">
