...
?>
<!--<img style="width:100%;opacity: 0.6;height:1035px;" src="images/iimsr-cmm-ok.jpeg" alt="DZone"/>-->
<img style="width:100%;opacity: 0.6;height:1105px;" src="images/iimsr-cmm-ok.jpeg" alt="DZone"/>
<table style="width:92%;margin-top:-915px;margin-left: 36px;opacity: 0.9;z-index:9999999;line-height:20px">
     <tr>
		<td style="font-size:11px;"><strong>Name : </strong><?php echo $row['name']; ?></td>
	</tr>
</table>
...
<table style="width:45%;margin-top:3px;float:left;margin-right:13px;margin-left: 30px;opacity: 0.9;" align="center">
    <tr>
		...
		<td width="4%"style="border: 1px solid #000;"><p class="rotate"> <b>NIT Marks</b> </p></td>
...
<table style="width:45%;margin-top:3px;">
    <tr>
		<td width="37%"style="text-align:center;font-size:11px;border: 1px solid #000;opacity: 0.9;"><strong>Subject Title <br><hr> Maximum Marks In Theory/Lab </strong></td>
		<td width="4%"style="border: 1px solid #000;"><p class="rotate"> <b>NIT Marks</b> </p></td>
		<td width="3%"style="border: 1px solid #000;"><p class="rotate"> <b>EXT Marks</b> </p></td>
		<td width="3%"style="border: 1px solid #000;"><p class="rotate"> <b>Total</b> </p></td>
		<td width="1%"style="border: 1px solid #000;"><p class="rotate"> <b>Grade</b> </p></td>
