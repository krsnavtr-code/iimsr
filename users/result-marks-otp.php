...
if($row > 0){
    $ResultOtp = rand(100000,999999);
    $query = mysqli_query($con, "UPDATE `register_here` SET `ResultOtp`='$ResultOtp' WHERE `enrolment`='$enrolment'");
    ...
    <tr>
        <td>
            ...
            <tr style='border-radius: 83px 45px 45px 45px;background-color: #0000001f;padding: 18px 0px 32px 0px;'>
                ...
                <td style='padding: 10px 0px 10px 10px;'>".$ResultOtp."</td>
            </tr>
        </td>
    </tr>    
    </table>
