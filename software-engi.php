...
<div class="content_wrapper">
    <div class="breadcrumb_wrap" data-stellar-background-ratio="0.3" style="background: url(images/slider_group_in_campus.jpg); background-attachment: fixed; background-position: 50% 50%;">
        <div class="breadcrumb_wrap_inner">
            <div class="container">
                <h1>After 10th/10+2</h1>
                <ul class="breadcrumbs">
                    <li><a href="/">Home</a> /</li>
                    <li><a href="software-engi.php">After 10th/10+2</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="dtl_block">
                        <div class="detail_text_wrap">
                            <div class="info_wrapper">
                                <h5>Category After 10th/10+2</h5>
                                <div class="panel-group" id="accordion">
                                    <?php 
                                        ...
                                        if($Category_id=='Technical Software1' && $total_fee && $eligibility){
                                    ?>
